...
def unet3D(pretrained_weights = None,input_size = (132,132,132,1), stage2=False):
    inputs = Input(input_size)
    conv1 = Conv3D(32, 3, activation = 'relu', padding = 'valid', kernel_initializer = 'he_normal')(inputs)
    conv1 = Conv3D(32, 3, activation = 'relu', padding = 'valid', kernel_initializer = 'he_normal')(conv1)
    ...
    if(stage2):
        ...
        drop4 = Conv3D(256, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(conv6)
    ...
    up8 = Conv3D(64, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(UpSampling3D(size = (2,2,2))(conv7))
    ...
    up9 = Conv3D(32, 3, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(UpSampling3D(size = (2,2,2))(conv8))
